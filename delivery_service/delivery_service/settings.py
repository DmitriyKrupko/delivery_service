...
SECRET_KEY = 'django-insecure-t17fh5755mo!ov_f*(#6x^$fhh*dg!#vy*65v2*!pgcy=kgp#='
...
INSTALLED_APPS = [
    ...
    'restaurants.apps.RestaurantsConfig',  # Убедитесь, что это указано только один раз
]
...
# Пути к статическим файлам приложения
STATICFILES_DIRS = [
